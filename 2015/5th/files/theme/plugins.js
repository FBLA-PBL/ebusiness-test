	...
	***************************/
    ...
    $.fn.jqTransSelect = function() {
        return this.each(function(index) {
			...
			// Removed since someone had the first li element blank and didn't work correctly for them;
            //var iSelectHeight = ($('li', $ul).length) * ($('li:first', $ul).height()); //+1 else bug ff
			
			var iSelectHeight = [].reduce.call($("li"), function(prior, now){
				if( typeof prior !== "number" ){ prior = prior.offsetHeight; }
				return prior + now.offsetHeight;
			});
